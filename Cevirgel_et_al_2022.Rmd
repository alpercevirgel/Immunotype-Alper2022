...
vital.sample <- read_excel("/Users/alpercevirgel/Documents/Alper RIVM/1_Complete_analysis_per_project/VITAL database/VITAL database Alper.xlsx",
...
beckman_coulter_d0 <- read_excel("/Users/alpercevirgel/Documents/Alper RIVM/1_Complete_analysis_per_project/VITAL database/VITAL database Alper.xlsx",
                                 sheet = "DxH500",
                                 skip = 1, 
                                 na = "n/a") %>% 
...
vital.truc_pneum_d0_stability <- read_excel("/Users/alpercevirgel/Documents/Alper RIVM/1_Complete_analysis_per_project/VITAL database/VITAL database Alper.xlsx",
...
adon1 <- adonis(formula = immune.data_T0 ~ age,
                method = "canberra", # method we need to decide
